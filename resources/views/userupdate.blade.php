  ...
  <div id="page-wrapper">
    <div class="container-fluid">
     ...
     <div class="row">
        <div class="col-md-6">
          <div class="white-box">
            <h3 class="box-title m-b-0">User data Update </h3>
            <br>
            <div class="row">
              <div class="col-sm-12 col-xs-12">
                <form action="{{ route('update.user', $user->id) }}" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Username" value="{{$user->name}}" name="name">
                  </div>
                  <div class="form-group">
